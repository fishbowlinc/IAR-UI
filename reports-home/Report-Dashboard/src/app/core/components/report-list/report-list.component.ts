...
export class ReportListComponent implements OnInit , OnDestroy {
  ...
  public report;
  constructor(private router:Router , private _authService: AuthService,  private route:ActivatedRoute, private dataService:DataService , private cookieService:CookieService) {
